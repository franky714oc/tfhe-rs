...
impl std::ops::Deref for ShortintWopbsLUT {
...
impl std::ops::DerefMut for ShortintWopbsLUT {
...
impl WopbsKey {
        ...
        F: Fn(u64) -> u64,
    {
        ...
        for (i, value) in lut.lut_mut().as_mut().iter_mut().enumerate().take(basis) {
