...
use crate::typed_api::traits::{FheDecrypt, FheEncrypt, FheEq, FheTryEncrypt, FheTryTrivialEncrypt, FheTrivialEncrypt};
        ...
        P::Id: Default + WithGlobalKey<Key=GenericBoolServerKey<P>>,
{
    ...
    fn try_encrypt_trivial(value: bool) -> Result<Self, Self::Error> {
        let id = P::Id::default();
        id.with_global(|key| {
            let ciphertext = key.key.trivial_encrypt(value.into());
