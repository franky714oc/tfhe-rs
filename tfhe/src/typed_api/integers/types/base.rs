...
use crate::typed_api::internal_traits::{EncryptionKey, DecryptionKey};
...
use crate::typed_api::integers::server_key::{
    ...
    SmartMul, SmartMulAssign, SmartNeg, SmartShl, SmartShlAssign, SmartShr, SmartShrAssign,
    SmartSub, SmartSubAssign, SmartMax, SmartMin
};
...
// #[cfg_attr(doc, doc(cfg(feature = "integer")))]
...
// TODO: needs trivial encrypt of u256 in integer
// impl<Clear, P> FheTryTrivialEncrypt<Clear> for GenericInteger<P>
//     where
//         Clear: Into<U256>,
//         P: StaticIntegerParameter,
//         P::Id: Default + WithGlobalKey<Key=GenericIntegerServerKey<P>>,
// {
//     type Error = crate::typed_api::errors::Error;
//
...
//         let id = P::Id::default();
//         id.with_global(|key| {
//             let ciphertext = key.key.create_trivial();
//             Ok(GenericInteger::new(ciphertext, id))
//         })?
//     }
// }
